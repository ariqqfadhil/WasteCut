...
function Footer({ setCurrentPage }) {
  // Handle navigation click with useCallback
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <section aria-labelledby="footer-about">
            <div className="flex items-center space-x-2 mb-4">
              <div 
                className="bg-white text-green-600 dark:bg-gray-800 dark:text-green-400 rounded-full w-10 h-10 flex items-center justify-center font-bold text-xl transition-all duration-300 hover:scale-110 hover:rotate-12" 
                aria-hidden="true"
              >
                W
              </div>
              <h2 id="footer-about" className="text-xl font-bold">WasteCut</h2>
            </div>
